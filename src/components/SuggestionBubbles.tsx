          ...
          {suggestions.map((suggestion, index) => {
            ...
            return (
              <button
                ...
                className="group flex items-center gap-2 p-2 bg-gray-900/70 hover:bg-gray-800/80 border border-gray-700/40 hover:border-gray-600/60 rounded-lg text-xs text-gray-300 hover:text-white transition-all duration-200 backdrop-blur-sm hover:shadow-md hover:shadow-blue-500/10 text-left"
              >
                <div className="w-6 h-6 rounded-md bg-gradient-to-br from-blue-500/20 to-indigo-500/20 border border-blue-500/30 flex items-center justify-center flex-shrink-0 group-hover:from-blue-500/30 group-hover:to-indigo-500/30 transition-all duration-200">
                  <Icon className="w-3 h-3 text-blue-400 group-hover:text-blue-300" />
                </div>
                <span className="font-medium leading-tight group-hover:text-blue-100 transition-colors duration-200 truncate">
                  {suggestion}
                </span>
              </button>
            );
