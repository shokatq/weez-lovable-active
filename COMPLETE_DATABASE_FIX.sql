-- Complete Database Fix for Viz.AI Workspace Management
-- Run this in your Supabase SQL Editor

-- 1. Drop all existing policies and functions to start fresh
...
-- 8. Create function to automatically add workspace owner as admin
...
-- 9. Create trigger to automatically add workspace owner as admin
...
-- 11. Note: Mock users are not needed - the system will work with real users from auth.users
-- The user search function will find real users who have signed up through Supabase Auth

-- 12. Add existing workspace owners as admins (if they're not already members)
INSERT INTO workspace_members (workspace_id, user_id, role)
